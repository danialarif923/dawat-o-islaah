...
URDU_TRANSLATION_MAP = {
    ...
    "sunan-darimi": "سنن دارمی",
    "muwatta-malik": "موطا مالک",
    "mustadrak-al-hakim": "مستدرک حاکم",
    "sahih-ibn-khuzaymah": "صحیح ابن خزیمہ",
}
...
# ✅ HADITH API (WITH SEARCH NAVIGATION SUPPORT)
@api_view(['GET'])
